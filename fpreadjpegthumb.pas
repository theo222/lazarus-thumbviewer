...
//Specialized version for loading prescaled (Thumbnails)

unit FPReadJPEGthumb;
...
var
  tn, ext:String;
  Om:TImageHandlersManager;
  ir:TFPCustomImageReaderClass;
  iw:TFPCustomImageWriterClass;
  i:integer;
